...
namespace FMBot.Persistence.EntityFrameWork.Migrations
{
    ...
    [Migration("20201018183753_RenameStoredArtistAlbumTrack")]
    partial class RenameStoredArtistAlbumTrack
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FMBot.Persistence.Domain.Models.CachedAlbum", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id")
            ...
            modelBuilder.Entity("FMBot.Persistence.Domain.Models.CachedArtist", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id")
            ...
            modelBuilder.Entity("FMBot.Persistence.Domain.Models.CachedTrack", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id")
                    ...
                    b.Property<int?>("CachedAlbumId")
                        .HasColumnName("cached_album_id")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("CachedAlbumId")
                        .HasName("ix_tracks_cached_album_id");
            ...
            modelBuilder.Entity("FMBot.Persistence.Domain.Models.InactiveUsers", b =>
                {
                    ...
                    b.HasIndex("UserId")
                        .HasName("ix_inactive_users_user_id");

                    b.HasIndex("UserId1")
                        .HasName("ix_inactive_users_user_id1");
            ...
            modelBuilder.Entity("FMBot.Persistence.Domain.Models.ArtistAlias", b =>
                {
                    b.HasOne("FMBot.Persistence.Domain.Models.CachedArtist", "CachedArtist")
                        .WithMany("ArtistAliases")
                        .HasForeignKey("ArtistId")
                        .HasConstraintName("fk_artist_aliases_artists_cached_artist_id")
            ...
            modelBuilder.Entity("FMBot.Persistence.Domain.Models.ArtistGenre", b =>
                {
                    b.HasOne("FMBot.Persistence.Domain.Models.CachedArtist", "CachedArtist")
                        ...
                        .HasForeignKey("ArtistId")
                        .HasConstraintName("fk_artist_genres_artists_cached_artist_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("FMBot.Persistence.Domain.Models.CachedAlbum", b =>
                {
                    b.HasOne("FMBot.Persistence.Domain.Models.CachedArtist", "CachedArtist")
                        .WithMany("Albums")
                        .HasForeignKey("ArtistId")
                        .HasConstraintName("fk_albums_artists_cached_artist_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("FMBot.Persistence.Domain.Models.CachedTrack", b =>
                {
                    b.HasOne("FMBot.Persistence.Domain.Models.CachedArtist", "CachedArtist")
                        .WithMany("Tracks")
                        .HasForeignKey("ArtistId")
                        .HasConstraintName("fk_tracks_artists_cached_artist_id");

                    b.HasOne("FMBot.Persistence.Domain.Models.CachedAlbum", null)
                        .WithMany("Tracks")
                        .HasForeignKey("CachedAlbumId")
                        .HasConstraintName("fk_tracks_albums_cached_album_id");
                });
